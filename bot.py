...
STAR_PACKAGES = {
    "10": {"stars": 50, "tokens": 10, "label": "50 ⭐ → 10 токенов", "old_price": 60},
    "25": {"stars": 100, "tokens": 25, "label": "100 ⭐ → 25 токенов", "old_price": 115},
    "50": {"stars": 200, "tokens": 50, "label": "200 ⭐ → 55 токенов", "old_price": 230},
    "100": {"stars": 400, "tokens": 100, "label": "400 ⭐ → 110 токенов", "old_price": 460},
}
...
async def cmd_help(message: Message):
    help_text = (
        ...
        f"🔥 <b>Цены со скидкой 15-20%:</b>\n"
        f"• 50 ⭐ → 10 токенов (было 57 ⭐)\n"
        f"• 100 ⭐ → 25 токенов (было 115 ⭐)\n"
        f"• 200 ⭐ → 55 токенов (было 230 ⭐)\n"
        f"• 400 ⭐ → 110 токенов (было 460 ⭐)"
    )
...
async def main():
    ...
    print("\n🔥 Цены со скидкой 15-20%:")
    print("   50 ⭐ → 10 токенов")
    print("   100 ⭐ → 25 токенов")
    print("   200 ⭐ → 55 токенов")
    print("   400 ⭐ → 110 токенов")
    print("\n📋 Команды:")
